...
import com.google.android.material.chip.ChipGroup; // Thêm import này
...
public class TaskListFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        initRecyclerView(view); // Thiết lập danh sách
        setupHeaderActions(view); // Thêm nút Sắp xếp
        setupFilterActions(view); // <--- TUI ĐÃ THÊM DÒNG NÀY Ở ĐÂY
        setupFab(view);    // Nút thêm mới
    }
    ...
    // --- 2. XỬ LÝ NÚT BẤM HEADER, FILTER & FAB ---
        ...
        if (btnSort != null) {
            btnSort.setOnClickListener(v -> {
                ...
                popup.setOnMenuItemClickListener(item -> {
                    taskViewModel.setSortOrder(item.getItemId()); // 1: Deadline, 2: Priority
    ...
    // --- 3. DIALOG THÊM & SỬA TASK (GIỮ NGUYÊN 100% CODE CŨ) ---
